...
class Perceptron:
    ...
    def __init__(self, face):  # Runs for each instance
        self.face = face
        self.epoch = 100 # Add epoch into __init__
        ...
        self.training_ans = self.training_ans_to_dict(self.path_to_ans, self.face) # Same for answers
        ...
        self.test_ans = self.training_ans_to_dict(self.path_to_test_ans, self.face)
    ...
    def training_ans_to_dict(self, path_to_ans, face):
        """
